...
* Is extendable through .extend() function similar to document/collection objects.
*/
class batch extends component {
  ...
  * @param {reference}
  * @return {promise} resolves when write is validated, or when full batch is commited (if commitWhenFull option set on this batch);
  */
  delete(ref){
