...
/**
* Initialize custom component high level extensions.
*/
//require('./collection.ext').extend(module.exports.collection);
//require('./document.ext').extend(module.exports.document);
/**
...
* If no path is specified, an automatically-generated unique ID will be used for the returned document.
* @param {string} relativePath to the document
* @return {document}
*/
module.exports.collection.prototype.document = function(relativePath){
    if(relativePath === undefined){
      relativePath = this.reference.doc().id;
    }
