...
module.exports.dataStruct = require('./dataStruct');
module.exports.collection = require('./collection');
module.exports.document = require('./document');
module.exports.util = require('./util');

/**
* Gets the parent collection object for this document.
...
* @return {collection}
*/
module.exports.document.prototype.collection = (relativePath) => {
...
* @return {document}
*/
module.exports.collection.prototype.doc = (relativePath) => {
