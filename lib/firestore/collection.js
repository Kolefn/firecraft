...
class collection extends component {
  ...
  *
  * Accesses a token that must be set in the functions config or as the environment variable FIREBASE_CLI_TOKEN.
  ...
  */
  delete(options={}){
    ...
    firebaseTools.firestore.delete(this._path.toString(), {
        project: process.env.GCLOUD_PROJECT,
        recursive: options.recursive,
        yes: true,
        token: process.env.FIREBASE_CLI_TOKEN || functions.config().fb.token
      });
  }
