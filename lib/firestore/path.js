...
class path extends component {
  ...
  */
   ...
   * @param  {path} other path object
   * @return {bool} true if the paths are equal. false if not.
   */
  equalTo(other){
    if(other == null || other == undefined){ return false; }
    else if(!other.constructor || !other.constructor.name || other.constructor.name !== 'path'){ return false; }
