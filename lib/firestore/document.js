...
class document extends dataStruct {
  ...
  */
  ...
  /**
  * Determine if the provided path (relative to an existing document) points to a document.
  * @override
  * @param {Array} pathSegments of the relative path
  * @return {bool} if the relative path points to a document
  */
  static isRelativePathValid(pathSegments){
    return document.isValidPath(pathSegments);
  }
